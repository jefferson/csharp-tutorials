        ...
        private List<OrderModel> GetOrderDemoModels()
        {
            List<OrderModel> orders = new List<OrderModel>
            {
                new OrderModel{
                    ...
                    CustomerID=2,
                    Item="Gibson LesPaul",
                    Price=double.Parse("2025.00", System.Globalization.CultureInfo.InvariantCulture),
                    Quantity=1
                },
                new OrderModel{
                    OrderID=2,
                    ...
                    Price=double.Parse("2525.00", System.Globalization.CultureInfo.InvariantCulture),
                    Quantity=2
                },
                new OrderModel{
                    OrderID=3,
                    ...
                    Price=double.Parse("1025.00", System.Globalization.CultureInfo.InvariantCulture),
                    Quantity=1
                },
                new OrderModel{
                    OrderID=4,
                    ...
                    Price=double.Parse("2542.00", System.Globalization.CultureInfo.InvariantCulture),
                    Quantity=1
                },
                new OrderModel{
                    OrderID=5,
