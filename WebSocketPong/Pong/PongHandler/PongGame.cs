...
namespace Adiwave.PongGame.PongHandler
{
    ...
    public class PongGame
    {
        ...
        public const int PlayerWidth = 7;
        public const int PlayerHeight = 100;
        public const int PlayerReach = PlayerToEdgeDistance + PlayerWidth;
        public const int BallRadius = 22;
        public const double BallStartingSpeedPixPerSecond = 80;
        public const double BallSpeedIncrease = 34;
