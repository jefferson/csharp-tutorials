...
Pong.prototype = {
    ...
    displayScore: function () {
        $(this.scoreSelector).html("The score is " + this.score[0] + ":" + this.score[1]);  /* [ BLUE : RED ] */
        if (this.myPlayer == 0 && this.score[1] > this.score[0]) {
            this.playerWidth = this.playerWidth / 2;  // Redure to 50px the vertical bar
        }
    },
